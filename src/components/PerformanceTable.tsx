        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="text-right">Portfolio Return
...
                </TableHead>
          ...
          <TableBody>
            {data.map(row => <TableRow key={row.year}>
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <span className="cursor-help border-b border-dotted border-muted-foreground/50">
                          ${row.endingMarketValue.toLocaleString(undefined, {
                ...
                <TableCell className={`text-right font-mono ${row.twrReturn >= 0 ? 'text-success' : 'text-destructive'}`}>
                  <TooltipProvider>
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <span className="cursor-help border-b border-dotted border-muted-foreground/50">
                ...
                <TableCell className={`text-right font-mono ${row.netFlows >= 0 ? 'text-success' : 'text-destructive'}`}>
                  <TooltipProvider>
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <span className="cursor-help border-b border-dotted border-muted-foreground/50">
                          ${row.netFlows.toLocaleString(undefined, {
                        minimumFractionDigits: 2
                      })}
                        </span>
                      </TooltipTrigger>
